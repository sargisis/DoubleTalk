        ...
        <div className="max-w-[800px] mx-auto flex flex-col gap-8 transition-colors duration-300">
            ...
            {currentCard ? (
                <div className="flex flex-col items-center">
                    ...
                    {/* Flashcard */}
                    <div
                        className={`w-full max-w-[500px] min-h-[300px] bg-white dark:bg-[#0f172a] rounded-[2rem] shadow-[0_10px_40px_rgba(175,32,36,0.1)] dark:shadow-none p-10 flex flex-col justify-center items-center text-center cursor-pointer transition-all duration-300 transform border dark:border-[#1e293b] ${isFlipped ? 'border-2 border-[#AF2024]/20 bg-[#FCF4F4] dark:bg-gray-800/80 dark:border-red-900/30' : 'hover:-translate-y-1'}`}
                        onClick={() => !isFlipped && setIsFlipped(true)}
                    >
                        <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">{currentCard.text}</h2>
